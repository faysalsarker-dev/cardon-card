...
const Featured = () => {
  return (
    <section className="my-10 md:my-12 md:pb-10  bg-black">
      ...
      <div className=" mx-auto ">
        <div className="flex flex-wrap md:flex-nowrap items-center justify-center md:justify-between w-full max-w-224.5 mx-auto py-6 px-3.75 gap-7.5 md:gap-0">
          <div className="flex-[0_0_45%] md:flex-initial text-center md:text-left">
            <img src={foxLogo} alt="Fox" className="max-w-full h-auto transition-opacity duration-300 hover:opacity-100" />
          </div>
          <div className="flex-[0_0_45%] md:flex-initial text-center md:text-left">
            <img src={usaTodayLogo} alt="USA Today" className="max-w-full h-auto transition-opacity duration-300 hover:opacity-100" />
          </div>
          <div className="flex-[0_0_45%] md:flex-initial text-center md:text-left">
            <img src={benzingaLogo} alt="Benzinga" className="max-w-full h-auto  transition-opacity duration-300 hover:opacity-100" />
          </div>
          <div className="flex-[0_0_45%] md:flex-initial text-center md:text-left">
            <img src={marketWatchLogo} alt="MarketWatch" className="max-w-full h-auto  transition-opacity duration-300 hover:opacity-100" />
          </div>
        </div>
      </div>
