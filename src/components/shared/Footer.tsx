...
const Footer = () => {
  return (
    <footer className="md:mt-34 mt-4 pt-6  pb-13 bg-background">
      <div className=" max-w-7xl mx-auto px-4">
        <div className="w-full flex flex-col lg:flex-row justify-between items-center lg:items-start text-center lg:text-left pb-1 md:pb-25.5 border-b border-border/15 gap-6 lg:gap-8">
          <div className="lg:mb-0 flex md:flex-col flex-row justify-between w-full">
            <Link to="/" className="h-6 md:w-75 w-25 max-w-[167.3px] block">
              <Logo />
            </Link>
            <p className="text-base text-muted-foreground mt-10 md:block hidden">Custom metal credit & debit cards</p>
            ...
            <div className="md:hidden flex items-center gap-2">
              <a title="Tiktok" target="_blank" href="https://www.tiktok.com/@carboncoskins" className="opacity-50 transition-opacity duration-400 hover:opacity-100 block lg:mt-0 lg:not-first:mt-12.5" rel="noreferrer">
                <img className="h-8 w-8" src="./footer/social_tiktok.svg" alt="Tiktok" />
              </a>
              <a title="Facebook" target="_blank" href="https://www.facebook.com/carboncoskins" className="opacity-50 transition-opacity duration-400 hover:opacity-100 block lg:mt-0 lg:not-first:mt-12.5" rel="noreferrer">
                <img className="h-8 w-8" src="./footer/social_fb.svg" alt="Facebook" />
              </a>
              <a title="Instagram" target="_blank" href="https://www.instagram.com/carboncoskins/" className="opacity-50 transition-opacity duration-400 hover:opacity-100 block lg:mt-0 lg:not-first:mt-12.5" rel="noreferrer">
                <img className="h-8 w-8" src="./footer/social_insta.svg" alt="Instagram" />
              </a>
            </div>

          </div>

          <div className="flex justify-center lg:justify-start items-start flex-wrap lg:flex-nowrap mb-10 lg:mb-0 gap-4 lg:gap-10">
            ...
            <div className="h-[1px] w-full border-b border-border/15 mt-5 -mb-5"></div>

            <div className="flex lg:hidden justify-center items-start gap-8 w-full mb-10">
              <div className="flex justify-start items-start flex-col">
                {/* <h4 className="font-bold text-2xl leading-8 text-primary">Our services</h4> */}
                <ul className="mt-10">
                  <li className=" last:mb-0"><Link to="/how-it-work" className="block text-base leading-6 text-muted-foreground hover:text-primary transition-colors duration-300 font-bold text-start">How it works</Link></li>
                  <li className=" last:mb-0"><a href="/best-sellers" className="block text-base leading-6 text-muted-foreground hover:text-primary transition-colors duration-300 font-bold text-start">Best sellers</a></li>
                  <li className=" last:mb-0"><Link to="/order" className="block text-base leading-6 text-muted-foreground hover:text-primary transition-colors duration-300 font-bold text-start">Design Your Own</Link></li>
                  <li className=" last:mb-0"><Link to="/faq" className="block text-base leading-6 text-muted-foreground hover:text-primary transition-colors duration-300 font-bold text-start">FAQ</Link></li>
                </ul>
              </div>
              <div className="flex justify-start items-start flex-col">
                {/* <h4 className="font-bold text-2xl leading-8 text-primary">Contact</h4> */}
                <ul className="mt-10">
                  <li className=" last:mb-0"><a href="mailto:info@carboncoskins.com" className="block text-base leading-6 text-muted-foreground hover:text-primary transition-colors duration-300 font-bold text-start">info@carboncoskins.com</a></li>
                  <li className=" last:mb-0"><a href="tel:+61450596920" className="block text-base leading-6 text-muted-foreground hover:text-primary transition-colors duration-300 font-bold text-start">+61 450 596 920</a></li>
                </ul>
              </div>
            </div>

            <div className="hidden lg:flex justify-start items-start flex-col min-w-45">
              <h4 className="font-bold text-2xl leading-8 text-primary">Contact</h4>
              <ul className="mt-10">
          ...
          <div className="hidden md:flex lg:flex-col gap-2 lg:gap-4">
            <a title="Tiktok" target="_blank" href="https://www.tiktok.com/@carboncoskins" className="opacity-50 transition-opacity duration-400 hover:opacity-100 block lg:mt-0 lg:not-first:mt-12.5" rel="noreferrer">
              <img className="h-20 w-20" src="./footer/social_tiktok.svg" alt="Tiktok" />
            </a>
            <a title="Facebook" target="_blank" href="https://www.facebook.com/carboncoskins" className="opacity-50 transition-opacity duration-400 hover:opacity-100 block lg:mt-0 lg:not-first:mt-12.5" rel="noreferrer">
              <img src="./footer/social_fb.svg" alt="Facebook" />
            </a>
            <a title="Instagram" target="_blank" href="https://www.instagram.com/carboncoskins/" className="opacity-50 transition-opacity duration-400 hover:opacity-100 block lg:mt-0 lg:not-first:mt-12.5" rel="noreferrer">
              <img src="./footer/social_insta.svg" alt="Instagram" />
            </a>
          </div>
        </div>

        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-end w-full pt-8 pr-0 lg:pr-7 gap-2 lg:gap-0">
          ...
          <div className="flex lg:hidden">
            <ul>
              <li className="last:mb-0"><a href="/terms-and-conditions" className="block text-base leading-6 text-muted-foreground hover:text-primary transition-colors duration-300 text-center">Terms & conditions</a></li>
              <li className="last:mb-0"><a href="/terms-and-conditions#privacy" className="block text-base leading-6 text-muted-foreground hover:text-primary transition-colors duration-300 text-center">Privacy policy</a></li>
            </ul>
          </div>
